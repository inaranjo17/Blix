...
const extensionService = __importStar(require("../services/extension.service"));
async function extendReservation(req, res) {
    try {
        const result = await extensionService.requestExtension(req.params.id, req.user.userId);
        res.json({
